static List<int> FlattenArray(List<object> inputArray)
    {
        ...
        foreach (var item in inputArray)
        {
            if (item is int)
            {
                flattenedList.Add((int)item);
            }
            else if (item is List<object>)
            {
                flattenedList.AddRange(FlattenArray((List<object>)item));
            }
            else
            {
                throw new ArgumentException("Did not find valid data type");
            }
        }
        ...
        List<object> nestedArray = new List<object>
        {
            ...
            new List<object>
            {
                ...
                new List<object>
                {
                    ...
                    new List<object> { 7155, 8056, 7834, 2639, 6601, 8063, 2390, 2544, 7022 }
                },
